...
VALUES(nextval('seq_user'), 'testeadotar@outlook.com', 'Joao Paulo', '12345678', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO users_roles
(user_id, role_id)
VALUES((SELECT id
FROM users
WHERE email='testeadotar@outlook.com'), (SELECT id
FROM roles
...
FROM users
WHERE email='testeadotar@outlook.com'));
...
FROM users
WHERE email='testeadotar@outlook.com')), (select id from users where email = 'testeadotar@outlook.com'));
